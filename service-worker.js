const CACHE = 'fincraft-v17'; // bumped: Loans & Savings LIST views redesigned to the screenshot spec (icon KPI strip, Status/Product/Branch filter bar, richer table). New multi-step full-page wizards for New Customer (Type→Personal→Identity→Review, with First/Middle/Surname → firstname/middlename/lastname), New Loan (Applicant→Loan Details→Assessment→Review) and Open Savings (Holder→Product→Terms→Review); dedicated routes client-new/loan-new/savings-new. New css/create-flows.css. Bump forces old browsers to drop stale CSS/JS.
