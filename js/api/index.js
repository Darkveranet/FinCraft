...
// Contract-driven layer: attach any generated resource not already curated
// above (additive only — hand-written resources always win). Regenerated by
// `npm run api:all`. See tools/api-automation/README.md.
import { mountGenerated } from './generated/client.generated.js';
mountGenerated(api);
