...
const PAGES = {
  ...
  'client-new':   {mod: () => import('./pages/clients.js'),     label: 'Register Customer', icon: 'fa-user-plus',  view: 'new', requiredPermission: 'CREATE_CLIENT' },
  loans:        { mod: () => import('./pages/loans.js'),        label: 'Loans',         icon: 'fa-hand-holding-dollar', requiredPermission: 'READ_LOAN' },
  'loan-new':   { mod: () => import('./pages/loans.js'),        label: 'New Loan Application', icon: 'fa-hand-holding-dollar', view: 'new', requiredPermission: 'CREATE_LOAN' },
  savings:      { mod: () => import('./pages/savings.js'),      label: 'Savings',       icon: 'fa-piggy-bank',     requiredPermission: 'READ_SAVINGSACCOUNT' },
  'savings-new':{ mod: () => import('./pages/savings.js'),      label: 'Open Savings Account', icon: 'fa-piggy-bank', view: 'new', requiredPermission: 'CREATE_SAVINGSACCOUNT' },
  ...
  tasks:        { mod: () => import('./pages/tasks.js'),        label: 'Approval Inbox', icon: 'fa-inbox',          requiredPermission: ANY_CHECKER_PERMISSION },
