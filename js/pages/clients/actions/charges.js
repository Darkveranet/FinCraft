...
export async function openApplyChargeModal(clientId, onSuccess) {
  let charges = [];
  try {
    const r = await api.charges.listByAppliesTo(3);
...
export async function openPayChargeModal(clientId, chargeId, onSuccess) {
  let paymentTypes = [];
